...
| [modules/security/](./modules/security/README.md) | Módulo security implementado (auth, RBAC, auditoría + data-model, events, decisions, features-analysis) | En progreso |
