...
Este documento establece los lineamientos, criterios y buenas prácticas para la creación, organización, nomenclatura, estructura y mantenimiento de la documentación del proyecto. Su propósito es garantizar la consistencia, claridad, trazabilidad y calidad de todos los documentos generados, facilitando su comprensión, búsqueda, actualización y reutilización.
...
- No crear carpetas raíz nuevas sin aprobación.
