...
| TD-004 | **Documentación por módulo**: `09-modules/modules/_template/` lista; `modules/security/` documentado desde 2026-09-01 (README, data-model, events, decisions, features-analysis; runbook pendiente). | Medio | P2 | 09-modules | Resuelto (instancia security) |
