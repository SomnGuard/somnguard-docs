...
| QR-002 | ¿Qué lenguaje usa el backend? | Java 21 (Spring Boot 3.x, Maven) | [ADR-001](../05-architecture/decisions/records/ADR-001-backend-java-spring-boot.md) | 2026-08-16 |
